...
if TYPE_CHECKING:
    ...
    from app.services.frame_queue.idle_scheduler import IdleScheduler

# ⭐ 直接使用 AgentWSManager 的 AgentStatus，避免重复定义
from app.services.agent_ws_manager import AgentStatus
...
class StateManagerProcessor(FrameProcessor):
    ...
    async def _transition_to(
        ...
        if not settings.INTERRUPTION_ENABLED:
            from app.services.mute_strategy import set_mute

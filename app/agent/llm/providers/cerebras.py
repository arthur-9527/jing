...
class CerebrasProvider(BaseLLMProvider):
    ...
    def __init__(
        ...
        """
        Args:
            api_key: Cerebras API Key，默认从 CEREBRAS_API_KEY 环境变量读取
            model: 默认模型，默认从 CEREBRAS_MODEL 环境变量读取
            fast_model: 快速模型，默认从 CEREBRAS_FAST_MODEL 读取
            base_url: API 端点 URL，默认从 CEREBRAS_API_BASE_URL 环境变量读取（用于中转）
        """
        ...
        self.fast_model = fast_model or os.getenv("CEREBRAS_FAST_MODEL", None)
        self.base_url = base_url or os.getenv("CEREBRAS_API_BASE_URL", None)
